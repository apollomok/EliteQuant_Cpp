...
QT_MOC_LITERAL(5, 34, 14), // "PlaceOrderSlot"
QT_MOC_LITERAL(6, 49, 5) // "order"

    },
    "ClientMQ\0UpdateSignal\0\0string\0msg\0"
    "PlaceOrderSlot\0order"
};
...
void ClientMQ::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->UpdateSignal((*reinterpret_cast< string(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientMQ::UpdateSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientMQ::UpdateSignal(string _t1)
{
