...
QT_MOC_LITERAL(4, 27, 14), // "PlaceOrderSlot"
QT_MOC_LITERAL(5, 42, 5) // "order"

    },
    "ClientMQ\0UpdateSignal\0\0msg\0PlaceOrderSlot\0"
    "order"
};
...
void ClientMQ::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->PlaceOrderSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ClientMQ::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientMQ::UpdateSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ClientMQ::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ClientMQ.data,
      qt_meta_data_ClientMQ,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ClientMQ::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClientMQ.stringdata0))
        return static_cast<void*>(const_cast< ClientMQ*>(this));
...
// SIGNAL 0
void ClientMQ::UpdateSignal(QString _t1)
{
