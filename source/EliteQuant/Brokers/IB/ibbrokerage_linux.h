...
#include <Engine/Data/marketdatafeed.h>
#include <mutex>
#include <string>
#include <memory>
...
namespace EliteQuant
{
	...
	public:
        ...
        void openOrder( OrderId orderId, const IBOfficial::Contract&, const IBOfficial::Order&, const IBOfficial::OrderState&);
        void openOrderEnd();
	...
	private:
		...
		//std::unique_ptr<EClientSocket> m_pClient;		// std::auto_ptr<EPosixClientSocket> m_pClient; or unique_ptr
