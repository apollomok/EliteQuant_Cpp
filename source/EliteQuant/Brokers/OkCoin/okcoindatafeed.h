#ifndef _EliteQuant_Brokers_OkCoindatafeed_H_
#define _EliteQuant_Brokers_OkCoindatafeed_H_
...
namespace EliteQuant
{
	...
	class okcoindatafeed : public marketdatafeed {
	public:
		okcoindatafeed();
		~okcoindatafeed();
	...
	private:
		...
		string _host = "www.okcoin.com";
		void Thread_GetQuoteLoop();
	};
}

#endif // _EliteQuant_Brokers_OkCoindatafeed_H_
