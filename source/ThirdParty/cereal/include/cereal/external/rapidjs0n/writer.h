#ifndef RAPIDJS0N_WRITER_H_
#define RAPIDJS0N_WRITER_H_
...
public:
	...
	Writer& EndObject(SizeType memberCount = 0) {
		(void)memberCount;
		RAPIDJS0N_ASSERT(level_stack_.GetSize() >= sizeof(Level));
		RAPIDJS0N_ASSERT(!level_stack_.template Top<Level>()->inArray);
